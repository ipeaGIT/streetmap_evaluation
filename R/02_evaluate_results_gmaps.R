...
## Galileo results
gmaps_geocoded_df <- read_csv("../../data/geocode/streetmap_eval/cnefe_gmaps/cnefe_geocoded_gmaps.csv")
...
output_sf <- "../../data/geocode/streetmap_eval/validated_sample_gmaps.gpkg"
output_csv <- "../../data/geocode/streetmap_eval/validated_sample_gmaps.csv"
...
validate_geocoding <- function(muni) {
  ...
  sample_df[gmaps_sf, on = .(cnefe_id),
            `:=`(lat = i.lat, lon = i.lon,
                 geocode_precision = i.PrecisionDepth)]
