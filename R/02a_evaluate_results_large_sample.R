...
## geocode completo
streetmap_geocoded_sf <- st_read("../../data/geocode/streetmap_eval/cnefe_large_sample_streetmap_geocode/cnefe_large_sample_streetmap_Geocoded_completo_v2.shp") %>%
  mutate(USER_code_ = as.character(USER_code_))
output_sf <- "../../data/geocode/streetmap_eval/validated_large_sample_completo.gpkg"
output_csv <- "../../data/geocode/streetmap_eval/validated_large_sample_completo.csv"


# Load sample addresses
streetmap_sample_df <- read_csv("../../data/geocode/streetmap_eval/cnefe_large_sample_streetmap.csv") %>%
